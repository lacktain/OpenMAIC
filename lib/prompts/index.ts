...
export const PROMPT_IDS = {
  ...
  BLUEPRINT_REVIEW_SME: 'blueprint-review-sme',
  BLUEPRINT_REVIEW_MERRILL: 'blueprint-review-merrill',
  BLUEPRINT_REVIEW_SCHON: 'blueprint-review-schon',
  BLUEPRINT_REVIEW_ADJUDICATOR: 'blueprint-review-adjudicator',
  BLUEPRINT_REVIEW_REVISION: 'blueprint-review-revision',
